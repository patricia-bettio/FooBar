...
function setFilters() {
  ...
  addFilterClick("Oktoberfest");
  addFilterClick("European Lager");
  addFilterClick("Stout");
  addFilterClick("Belgian Specialty Ale");
  addFilterClick("California Common");

  //event listener function - for all
  function addFilterClick(category){
    document.querySelector("[data-filter='"+ category + "']").addEventListener("click", function(){filterBeer(category)});
  }
